...
Adobe Illustrator 上でルビ（ふりがな）を振るためのスクリプトです。
...
- [akiyo-as/illustrator_ruby_GUI](https://github.com/akiyo-as/illustrator_ruby_GUI) – 本スクリプトをベースに，ルビを GUI 上から配置できるようにしたスクリプトです。[関連記事](https://note.com/akitectura/n/n4ca72e1ac91a)
- [難しい地名もスラスラ読める！ふりがな日本地図帳](https://www.heibonsha.co.jp/book/b674323.html) – 本スクリプトを拡張したスクリプトを用いてルビ振りが行われた地図帳です。[関連記事](https://www.hcpc.co.jp/column/all-furigana-map/20260511.html)
